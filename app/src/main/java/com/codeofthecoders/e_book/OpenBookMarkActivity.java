...
public class OpenBookMarkActivity extends AppCompatActivity {

    ProgressDialog progressDialog;
    String book_name;
    TextView txt_title,txt_by_author,txt_book,txt_category,txt_category2,txt_bookmark,txt_descripation,txt_price;
    ImageView iv_thumb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openbookdetailsbookmark);
    ...
    private void Removebookmark() {
        ...
        final String u_name = String.valueOf(SharedPrefManager.getInstance(OpenBookMarkActivity.this).getUsername());
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
                Constants.URL_REMOVEBOOKMARK, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                progressDialog.dismiss();
    ...
    public void show(){
        ...
        amt.setText(Amount);
        uId.setText("pateldarshak067@okicici");
    ...
    private void addOrder() {
        ...
        final String u_id = String.valueOf(SharedPrefManager.getInstance(OpenBookMarkActivity.this).getUserId());
        final String u_name = String.valueOf(SharedPrefManager.getInstance(OpenBookMarkActivity.this).getUsername());
        final String u_email = String.valueOf(SharedPrefManager.getInstance(OpenBookMarkActivity.this).getUserEmail());
        Amount = String.valueOf(Price);
        ...
        StringRequest request = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(OpenBookMarkActivity.this, response, Toast.LENGTH_SHORT).show();
                Intent i = new Intent(getApplicationContext(),MainDashBoard.class);
                startActivity(i);
                finish();
            }
